...
use rs_pfcp::ie::{
    user_plane_path_recovery_report::RemoteGtpuPeer, GtpuPathQosControlInformation, Ie,
...
fn test_user_plane_path_recovery_report_integration() {
    ...
    assert_eq!(
        unmarshaled.remote_gtpu_peer.ipv4_address,
...
fn test_gtpu_path_qos_control_info_integration() {
    ...
    assert_eq!(
        ie.ie_type,
        rs_pfcp::ie::IeType::GtpuPathQosControlInformation
    );
