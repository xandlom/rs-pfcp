...
**Created:** 2025-12-14
**Target Release:** Q1 2026 (after v0.2.x matures)
...
v0.3.0 will be the **first major breaking release** since v0.2.0, focusing on **type safety** and **better error handling**. This release bundles all deferred breaking changes from the API improvements roadmap.

**Goals:**

1. ✅ Replace `io::Error` with structured `PfcpError` type
2. ✅ Add newtype wrappers for type-safe primitives
3. ✅ Remove deprecated methods from v0.2.x
4. ✅ Maintain 100% test coverage
5. ✅ Provide clear migration guide

**Timeline:** 2-3 weeks total development + 2-4 weeks community feedback
...
### 1. Custom Error Type (`PfcpError`) - HIGH PRIORITY
...
### 2. Newtype Wrappers - MEDIUM PRIORITY
...
|-------|------|--------|------|
| **Phase 1** | Custom Error Type | 6-8 days | MEDIUM |
| **Phase 2** | Newtype Wrappers | 2-3 days | LOW |
| **Phase 3** | Cleanup & Polish | 2-3 days | LOW |
| **Community** | Review Period | 2-4 weeks | LOW |
| **Total** | Development | 10-14 days | MEDIUM |
