...
fn display_up_function_features(payload: &[u8]) -> Option<IeDisplayResult> {
    ...
    let flags: Vec<&str> = [
        ...
        (UPFunctionFeatures::QUOAC, "QUOAC"),
        (UPFunctionFeatures::TRACE, "TRACE"),
        (UPFunctionFeatures::FRRT, "FRRT"),
        (UPFunctionFeatures::PFDE, "PFDE"),
        (UPFunctionFeatures::EPFAR, "EPFAR"),
        (UPFunctionFeatures::DPDRA, "DPDRA"),
        (UPFunctionFeatures::ADPDP, "ADPDP"),
        (UPFunctionFeatures::UEIP, "UEIP"),
        (UPFunctionFeatures::SSET, "SSET"),
        (UPFunctionFeatures::MNOP, "MNOP"),
        (UPFunctionFeatures::MTE, "MTE"),
        (UPFunctionFeatures::BUNDL, "BUNDL"),
        (UPFunctionFeatures::GCOM, "GCOM"),
        (UPFunctionFeatures::MPAS, "MPAS"),
        (UPFunctionFeatures::RTTL, "RTTL"),
        (UPFunctionFeatures::VTIME, "VTIME"),
        (UPFunctionFeatures::NORP, "NORP"),
        (UPFunctionFeatures::IPTV, "IPTV"),
        (UPFunctionFeatures::IP6PL, "IP6PL"),
        (UPFunctionFeatures::TSN, "TSN"),
        (UPFunctionFeatures::MPTCP, "MPTCP"),
        (UPFunctionFeatures::ATSSS_LL, "ATSSS-LL"),
        (UPFunctionFeatures::QFQM, "QFQM"),
        (UPFunctionFeatures::GPQM, "GPQM"),
        (UPFunctionFeatures::MT_EDT, "MT-EDT"),
        (UPFunctionFeatures::CIOT, "CIOT"),
        (UPFunctionFeatures::ETHAR, "ETHAR"),
        (UPFunctionFeatures::DDDS, "DDDS"),
        (UPFunctionFeatures::RDS, "RDS"),
        (UPFunctionFeatures::RTTWP, "RTTWP"),
        (UPFunctionFeatures::QUASF, "QUASF"),
        (UPFunctionFeatures::NSPOC, "NSPOC"),
        (UPFunctionFeatures::L2TP, "L2TP"),
        (UPFunctionFeatures::UPBER, "UPBER"),
        (UPFunctionFeatures::RESPS, "RESPS"),
        (UPFunctionFeatures::IPREP, "IPREP"),
        (UPFunctionFeatures::DNSTS, "DNSTS"),
        (UPFunctionFeatures::DRQOS, "DRQOS"),
        (UPFunctionFeatures::MBSN4, "MBSN4"),
        (UPFunctionFeatures::PSUPRM, "PSUPRM"),
        (UPFunctionFeatures::EPPPI, "EPPPI"),
        (UPFunctionFeatures::RATP, "RATP"),
        (UPFunctionFeatures::UPIDP, "UPIDP"),
        (UPFunctionFeatures::AFSFC, "AFSFC"),
        (UPFunctionFeatures::MPQUIC, "MPQUIC"),
        (UPFunctionFeatures::REDSM, "REDSM"),
        (UPFunctionFeatures::DBDM, "DBDM"),
        (UPFunctionFeatures::TSCTS, "TSCTS"),
        (UPFunctionFeatures::DRTSC, "DRTSC"),
        (UPFunctionFeatures::N6JEDB, "N6JEDB"),
        (UPFunctionFeatures::QMCON, "QMCON"),
        (UPFunctionFeatures::DETNET, "DETNET"),
        (UPFunctionFeatures::EML4S, "EML4S"),
        (UPFunctionFeatures::PDUSM, "PDUSM"),
        (UPFunctionFeatures::CN_TL, "CN-TL"),
        (UPFunctionFeatures::QMDRM, "QMDRM"),
        (UPFunctionFeatures::EDBNC, "EDBNC"),
        (UPFunctionFeatures::MT_SDT, "MT-SDT"),
        (UPFunctionFeatures::UPSBIES, "UPSBIES"),
        (UPFunctionFeatures::UMN6IP, "UMN6IP"),
        (UPFunctionFeatures::UN6TU, "UN6TU"),
        (UPFunctionFeatures::MBSCH, "MBSCH"),
        (UPFunctionFeatures::ULM, "ULM"),
    ]
    .into_iter()
