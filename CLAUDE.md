...
- 1,940 comprehensive tests with round-trip validation
...
- `*.pcap` files - Generated by examples (ethernet-session-demo, etc.) - not tracked in git
- `docs/ts_129244v181000p/` - 3GPP TS 29.244 v18.10.0 specification documents (PDF conversions) - not tracked in git
...
- **Ethernet Support**: ✅ Recently added - Ethernet Packet Filter, MAC Address IE, Ethernet Context Information with PCAP generation support
- **Phase 2 Sprint 2**: ✅ Completed (17/17 IEs) - Advanced rate/status IEs, flow information, timing controls (1,940 tests passing)
